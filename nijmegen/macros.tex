...
\newcommand{\tTY}{\mathcal{T}\kern-0.4ex\mathit{y}}
\newcommand{\TY}[3]{\tTY^{#3}_{#2\in#1}}
\newcommand{\TYhat}[3]{\widehat{\tTY}^{#3}_{#2\in#1}}
\newcommand{\tEL}{\mathcal{E}\kern-0.2ex\ell}
\newcommand{\EL}[4]{\tEL^{#3}_{#2\in#1}(#4)}
\newcommand{\ELhat}[4]{\widehat{\tEL}^{#3}_{#2\in#1}(#4)}

\newcommand{\tCXT}{\mathcal{C}\kern-0.4ex\mathit{xt}}
\newcommand{\CXT}[2]{\tCXT_{#2\in#1}}
\newcommand{\tVAL}{\mathcal{V}\kern-0.4ex\mathit{al}}
\newcommand{\VAL}[2]{\tVAL_{#2\in#1}}

\newcommand{\DenG}[3]{\Den{#1}{#3\in#2}}
...
\newcommand{\ON}{{\mathcal{O}\!\mathit{n}}}
\newcommand{\ONhat}{\widehat{\ON}}
\newcommand{\NAT}{{\mathcal{N}\!\mathit{at}}}
\newcommand{\NAThat}{\widehat{\mathcal{N}\!\mathit{at}}}
