...
\newcommand{\Fomega}{\ensuremath{\mathsf{F}_\omega}}
\newcommand{\Fomegacop}{\ensuremath{\mathsf{F}_\omega^{\mathsf{cop}}}}
\newcommand{\der}{\,\vdash}
\newcommand{\derP}{\der}%^+}
\newcommand{\of}{{:}}
\newcommand{\is}{\!=\!}
...
\newcommand{\wec}[1]{\overrightharpoon{#1}}
...
\newcommand{\tonon}[1]{#1\tox\pin}
\newcommand{\leqmix}{\leq^{\pmixed}}
...
% paragraphs
\newcommand{\para}[1]{\paragraph*{#1}}%{\it#1}}
\newcommand{\paradot}[1]{\para{#1.}}

% proof by cases
\newenvironment{caselist}{%
  \begin{list}{{\it Case}}{\setlength{\leftmargin}{2ex}\setlength{\itemindent}{0ex}}%
}{\end{list}%
}
\newenvironment{subcaselist}{%
  \begin{list}{{\it Subcase}}{\setlength{\leftmargin}{2ex}\setlength{\itemindent}{0ex}}%
}{\end{list}%
}
...
\newcommand{\snu}[1]{\nu^{#1}}
\newcommand{\muinf}{\mu^{\infty}X}
\newcommand{\nuinf}{\nu^{\infty}X}
\newcommand{\SPI}[1]{\ensuremath{\Pi\,#1\,}}
\newcommand{\PIAF}{\SPI\A\F}
\newcommand{\tcl}{\mathsf{cl}}
\newcommand{\cl}[1]{\tcl(#1)}
\newcommand{\DenA}[1]{\Den{#1}{\A?}}
\newcommand{\tyint}[4]{(#1,#2)\in\TYPE_{#3}{#4}}
...
\newcommand{\muSP}{\SP_\mu}
\newcommand{\nuSP}{\SP_\nu}
\newcommand{\trunmu}{\mathsf{run}_\mu}
\newcommand{\trunnu}{\mathsf{run}_\nu}
% \newcommand{\muSP}{\mu\SP}
% \newcommand{\nuSP}{\nu\SP}
% \newcommand{\trunmu}{\mu\mathsf{run}}
% \newcommand{\trunnu}{\nu\mathsf{run}}
\newcommand{\trun}{\mathsf{run}}
\newcommand{\tget}{\mathsf{get}}
\newcommand{\tput}{\mathsf{put}}
\newcommand{\tout}{\mathsf{out}}
\newcommand{\vsp}{\mathit{sp}}
\newcommand{\tforce}{\mathsf{force}}
\newcommand{\Str}{\mathsf{Str}}
\newcommand{\vas}{\mathit{as}}
\newcommand{\vvs}{\mathit{vs}}
\newcommand{\vvss}{\mathit{vss}}
\newcommand{\ssv}{\mathit{ss}} %\vss is taken...
\newcommand{\thd}{\mathsf{hd}}
\newcommand{\sftl}{\mathsf{tl}}
...
\newcommand{\tstreams}{\mathsf{streams}}
\newcommand{\tbfp}{\mathsf{bfp}}
\newcommand{\tfixR}{\mathsf{fixR}}
% \newcommand{\ihat}{{\hat\imath}}
\newcommand{\ihat}{{i'}}
% \newcommand{\jhat}{{\hat\jmath}}
 \newcommand{\jhat}{{j'}}
\newcommand{\tf}{\mathsf{f}}
\newcommand{\tkUnit}{\mathsf{kUnit}}
\newcommand{\tbadLam}{\mathsf{badLam}}
\newcommand{\tbadCond}{\mathsf{badCond}}

% measure erasue (WAS: |.|)
\newcommand{\merase}[1]{\llparenthesis#1\rrparenthesis}

\newcommand{\proj}[2]{#1~.#2}
\newcommand{\projp}[2]{(#1)~.#2}
\newcommand{\declty}[2]{#1 \der #2}%{#1 \der_m #2}
\newcommand{\bden}[2]{\Den[<#1]{#2}{}}
\newcommand{\bmodels}[2]{\models^{#1}#2}
\newcommand{\bodymodels}[2]{\models_{\mathsf{body}}^{#1}#2}
...
\newcommand{\SizeVar}{\mathsf{SizeVar}}
\newcommand{\SizeExp}{\mathsf{SizeExp}}
\newcommand{\SizeCxt}{\mathsf{SizeCxt}}
\newcommand{\DataType}{\mathsf{DataType}}
\newcommand{\tsize}{\mathsf{size}}
\newcommand{\Tsize}{\mathord{{\leq}\infty}}
\newcommand{\lt}{{<}}
\newcommand{\suc}{\$}
\newcommand{\TyCons}{\mathsf{TyCons}}
\newcommand{\TyAtom}{\mathsf{TyAtom}}
...
\newcommand{\Copat}{\mathsf{Copat}}
\newcommand{\PatSp}{\mathsf{PatSp}}
\newcommand{\TyPat}{\mathsf{TyPat}}
\newcommand{\vcl}{\mathit{cl}}
\newcommand{\NeExp}{\App}%\mathsf{NeExp}}
...
\newcommand{\caseof}[3]{\tcase\,#1\,(#2 \To #3)}
\newcommand{\caseofp}[3]{\tcase\,(#1)\,(#2 \To #3)}
...
\newcommand{\bforall}[1]{\forall_{\lt{#1}}\,}
%\newcommand{\tbexists}{\exists\!\mathord{<}}
\newcommand{\bexists}[1]{\exists_{\lt{#1}}\,}
\newcommand{\existslt}[2]{\exists #1{\lt#2}.\,}
\newcommand{\foralllt}[2]{\forall #1{\lt#2}.\,}
\newcommand{\forallk}{{\forall_\kappa}}
\newcommand{\existsk}{{\exists_\kappa}}
...
\newcommand{\cA}{{{}^{?}\kern-.6ex A}}
\newcommand{\cB}{{{}^{?}\kern-.3ex B}}
\newcommand{\prequote}[1]{{{}'\kern-.3ex #1}}
\newcommand{\mdelta}{\prequote\delta}
\newcommand{\mGamma}{\prequote\,\Gamma}
\newcommand{\MType}{\mathsf{MType}}
\newcommand{\CType}{\mathsf{CType}}
\newcommand{\Cond}{\mathsf{Cond}}
\newcommand{\Block}{\mathsf{Block}}
\newcommand{\trefl}{\mathsf{refl}}
\newcommand{\incompat}{\mathrel{\lightning}}
\newcommand{\mcompatible}{\mbox{ compatible}}

\newcommand{\relR}[1][]{\mathrel{R#1}}
\newcommand{\relS}[1][]{\mathrel{S#1}}

% judgements
\newcommand{\match}[4]{#1 ~ / ~ #2 \searrow #3;#4}
\newcommand{\semty}[4]{#1; #2 \der #3 \in #4}
...
\newcommand{\KICXT}{\mathsf{KICXT}}
\newcommand{\SICXT}{\mathsf{SICXT}}
\newcommand{\CR}{\mathsf{CR}}
\newcommand{\CRlaw}[1]{\textbf{CR#1}}
\newcommand{\lawCR}{\CRlaw}
\newcommand{\ored}{\mathord{\red}}
\newcommand{\MU}{\boldsymbol{\mu}}
\newcommand{\NU}{\boldsymbol{\nu}}
\newcommand{\MUINF}{\MU^\INFTY}
\newcommand{\NUINF}{\NU^\INFTY}
\newcommand{\FORALL}{\bm\forall\kern-1.38ex\bm\forall}
\newcommand{\FORALLK}{\FORALL_{\K}}
...
\newcommand{\SIGP}[1]{\Sigma_{#1}} % parentheses are not needed
\newcommand{\SIGp}[2]{\Sigma_{#1}{(#2)}} % parentheses around the second arg
\newcommand{\ordto}{\mathord{\to}}
\newcommand{\TO}{\pmb{\to}}
%\newcommand{\TO}{\mathop{\bm\ordto\kern-2.55ex\raisebox{0.03em}{\ensuremath{\bm\ordto}}}}
\newcommand{\SIZE}{\mathsf{Size}}
\newcommand{\ON}{\mathsf{O}}
\renewcommand{\O}{\ON}
...
\newcommand{\vqs}{\mathit{qs}}
\newcommand{\qs}{\vec q}
\newcommand{\qsprime}{\vec q\,'}
\newcommand{\esprime}{\vec e\,'}
\newcommand{\qsp}{\mathbf{q}} % copattern spine
\newcommand{\qspp}{\qsp'} % copattern spine
...
\newcommand{\pfunT}[3]{(#1 \of #2#3) \to}
\newcommand{\bfunT}[2]{(#1 {<} #2) \to}
