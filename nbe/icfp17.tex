...
Our type theory is formulated via the following judgements, which are mutually inductively defined.
\[
...
\end{array}
\]
In addition, we will refer to the following derived judgements.
\[
\begin{array}{l@{\quad}l@{\quad}l@{~}l@{~~}l}
  ...
  \Gamma \der a = b : \Size & \defas &
    ...
    & \mbox{sizes $a$, $b$ are well-formed and identical} \\
...
%     \multicolumn 2 {l@{\qquad}} {\Gamma \der a : \Size \mand \Gamma \der b : \Size \mand a \leq b}
    & \mbox{sizes $a$, $b$ are well-formed and comparable} \\
