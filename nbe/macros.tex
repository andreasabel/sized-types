...
\newcommand{\RTy}[3]{\mathop{\mathsf{R}}\nolimits^{\mathsf{ty}}_{#1} \, #2 \evalsto #3}
\newcommand{\RNe}[3]{\mathop{\mathsf{R}}\nolimits^{\mathsf{ne}}_{#1} \, #2 \evalsto #3}
\newcommand{\RNat}[3]{\mathop{\mathsf{R}}\nolimits^{\mathsf{nat}}_{#1} \, #2 \evalsto #3}
\newcommand{\RSize}[3]{\mathop{\mathsf{R}}\nolimits^{\mathsf{size}}_{#1} \, #2 \evalsto #3}
\newcommand{\RElim}[3]{\mathop{\mathsf{R}}\nolimits^{\mathsf{elim}}_{#1} \, #2 \evalsto #3}
...
\newcommand{\LRSub}[4]{#1 \der #2 : #3 \circleR #4}
\newcommand{\LRSize}[3]{#1 \der #2 : \Size \circleR #3}
\newcommand{\LRT}[3]{#1 \der #2 \circleR #3}
